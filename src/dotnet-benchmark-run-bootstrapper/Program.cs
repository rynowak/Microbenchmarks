    ...
    public abstract class ProgramCore
    {
        ...
        private void RunTests(XunitPerformanceProject project)
        {
            ...
            if (string.IsNullOrEmpty(Environment.GetEnvironmentVariable("XUNIT_PERFORMANCE_MIN_ITERATION")))
                startInfo.EnvironmentVariables["XUNIT_PERFORMANCE_MIN_ITERATION"] = MinIterations.ToString();

            if (string.IsNullOrEmpty(Environment.GetEnvironmentVariable("XUNIT_PERFORMANCE_MAX_ITERATION")))
                startInfo.EnvironmentVariables["XUNIT_PERFORMANCE_MAX_ITERATION"] = MaxIterations.ToString();

            if (string.IsNullOrEmpty(Environment.GetEnvironmentVariable("XUNIT_PERFORMANCE_MAX_ITERATION_INNER_SPECIFIED")))
                startInfo.EnvironmentVariables["XUNIT_PERFORMANCE_MAX_ITERATION_INNER_SPECIFIED"] = MaxIterationsWhenInnerIterationsSpecified.ToString();

            if (string.IsNullOrEmpty(Environment.GetEnvironmentVariable("XUNIT_PERFORMANCE_MAX_TOTAL_MILLISECONDS")))
                startInfo.EnvironmentVariables["XUNIT_PERFORMANCE_MAX_TOTAL_MILLISECONDS"] = MaxTotalMSPerTest.ToString();
            ...
            var logger = new EtwPerformanceMetricLogger(project);
